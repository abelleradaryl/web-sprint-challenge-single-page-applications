...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
    useRouteMatch hook try's to match a current URL in the same way that Route would. It's useful for getting access to the match data without rendering a Route.
1. How would you explain form validation to someone who has never programmed before?
    Form validation is a way to guide and correctly input the correct information in the required fields. We can do this by creating error messages and not allowing them to submit the form until all the error messages are resolved.
1. In 1-2 sentences, define end to end testing.
    End to end testing is like a final test to make sure everything is running the way you intended it to. You can create your own test for each aspect of your code.
